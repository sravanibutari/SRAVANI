...
@Setter
public class Todo4 {
	private Tester3 task;
	//private RandomFortuneSeervice fortuneSeervice;
	private String todoId;
	private LocalDate date;
	private boolean isCompleted;

	public Todo4(Tester3 task /*RandomFortuneSeervice fortuneSeervice*/) {

		this.task = task;
		//this.fortuneSeervice = fortuneSeervice;
	}

	public Todo4 createTodo(String author, String taskName, boolean isCompleted) {
		/*
		...
		task=task.createTester3(author, taskName);
